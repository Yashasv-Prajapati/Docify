...
const DummyContainer: React.FC = () => {
    ...
    const fetchDataFromAPI = async () => {
        try {
            ...
            const response = await fetch('http://host.docker.internal:3000/api/dummy_container');
    ...
    return (
        <div>
            ...
            {loading && <Loader progressValues={[40, 70, 100]} />} {/* Render loader component if loading is true */}
        </div>
    );
};
