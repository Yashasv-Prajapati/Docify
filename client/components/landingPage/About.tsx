...
const About = () => (
  <section
    className={`${styles.paddings} relative z-10 mt-5 h-auto lg:h-screen `}
  >
    ...
    >
      ...
      >
        <div className='flex flex-row items-center'>
          <blockquote className='w-2/3  p-8 text-2xl text-gray-900 '>
            <svg
          ...
          <div className='border-l-2'>
            <Lottie
              ...
              className='mx-auto ml-10 size-[300px] object-contain  xl:size-[550px]'
            />
          </div>
        </div>
      </motion.div>
