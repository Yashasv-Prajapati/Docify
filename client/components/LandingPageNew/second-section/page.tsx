...
const features = [
  ...
  {
    name: 'UML Diagrams',
    description: 'Visualize code architecture with automated UML diagrams.',
    image: '/uml.png',
    alt: 'UML',
  },
  {
    name: 'Dependency',
    description: 'Streamline dependency management for efficient development.',
    image: '/dep.jpg',
    alt: 'Dependency',
  },
  {
  ...
  },
  {
    ...
    image: '/Docu.png',
    description:
      ' Streamline documentation and README generation with automated tools and edit them with ease.',
    alt: 'Documentation',
  },
];
